...
public class SpringSwaggerExtension extends AbstractSwaggerExtension {
    ...
    private BeanParamInjectParamExtention beanParamInjectParamExtention=new BeanParamInjectParamExtention();
    ...
    public List<Parameter> extractParameters(List<Annotation> annotations, Type type, Set<Type> typesToSkip, Iterator<SwaggerExtension> chain) {
        ...
        if(hasApiParam){
            parameters.addAll( beanParamInjectParamExtention.extractParameters(annotations,type,typesToSkip,chain));
        }else {
            for (Annotation annotation : annotations) {
